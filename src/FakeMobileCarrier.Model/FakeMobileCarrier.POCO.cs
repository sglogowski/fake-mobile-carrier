...
namespace FakeMobileCarrier.Model
{
    using System.Linq;

    #region Unit of work

    public interface IFakeMobileCarrierDbContext : System.IDisposable
    {
    ...
    public class FakeMobileCarrierDbContext : System.Data.Entity.DbContext, IFakeMobileCarrierDbContext
    {
        public System.Data.Entity.DbSet<User> Users { get; set; } // Users

        static FakeMobileCarrierDbContext()
        {
            System.Data.Entity.Database.SetInitializer<FakeMobileCarrierDbContext>(null);
        }
        ...
        public FakeMobileCarrierDbContext(string connectionString)
        ...
        public FakeMobileCarrierDbContext(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
        }

        public FakeMobileCarrierDbContext(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
    ...
    public class FakeMobileCarrierDbContextFactory : System.Data.Entity.Infrastructure.IDbContextFactory<FakeMobileCarrierDbContext>
    {
        public FakeMobileCarrierDbContext Create()
        {
            return new FakeMobileCarrierDbContext();
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.2.0")]
    public class FakeFakeMobileCarrierDbContext : IFakeMobileCarrierDbContext
    {
    ...
    public class User
    {
        ...
        public string PhoneNumber { get; set; } // PhoneNumber (Primary key) (length: 9)
        public string Pesel { get; set; } // PESEL (Primary key) (length: 11)
    }
    ...
    public class UserConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<User>
    {
        ...
        public UserConfiguration(string schema)
        {
            ...
            HasKey(x => new { x.UserId, x.FirstName, x.LastName, x.PhoneNumber, x.Pesel });
            ...
            Property(x => x.PhoneNumber).HasColumnName(@"PhoneNumber").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(9).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.Pesel).HasColumnName(@"PESEL").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(11).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
        }
    }
